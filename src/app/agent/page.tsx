...
function AgentContent() {
  ...
  if (isAuthenticated) {
    return (
      <div className="w-screen h-screen  shadow-lg flex items-center justify-center flex-col  bg-gradient-to-br from-gray-900 via-black to-gray-900 relative overflow-hidden">
        {/* Logout button */}
